...
import dugsolutions.leaf.v14.game.acquire.domain.FakeCombination
...
class PossibleDiceTest {
    ...
    companion object {
        val d4 = FakeCombination.sampleDie.d4
        val d6 = FakeCombination.sampleDie.d6
        val d8 = FakeCombination.sampleDie.d8
        val d10 = FakeCombination.sampleDie.d10
    }
    ...
    fun invoke_whenMultipleCombinationsCanBuyTheSameDie_returnsOnlyBestOne() {
        ...
        assertEquals(1, result.size)
        assertEquals(d10, result[0].die)
        assertEquals(combination2, result[0].combination)
    }
} 
