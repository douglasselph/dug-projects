...
/**
 * Interactive version of DecisionRerollOneDie that uses DecisionTaskHandler.
 * 
 ...
 */
class DecisionRerollOneDieSuspend : DecisionRerollOneDie {
     ...
     */
    suspend fun invokeSuspend(): Boolean {
