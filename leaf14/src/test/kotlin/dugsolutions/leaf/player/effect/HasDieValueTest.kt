...
class HasDieValueTest {
    ...
    private lateinit var sampleHandDie: HandItem.aDie
    ...
    fun setup() {
        ...
        sampleHandDie = HandItem.aDie(sampleDie)
    }
    ...
    fun invoke_whenDiceWithMatchingValue_returnsTrue() {
        ...
        val result = SUT(listOf(sampleHandDie), 6)
    ...
    fun invoke_whenDiceWithDifferentValue_returnsFalse() {
        ...
        // Act
        val result = SUT(listOf(sampleHandDie), 4)
    ...
    fun invoke_whenMixedItemsWithMatchingDice_returnsTrue() {
        // Act
        sampleDie.adjustTo(6)
        val result = SUT(listOf(sampleHandCard, sampleHandDie), 6)
