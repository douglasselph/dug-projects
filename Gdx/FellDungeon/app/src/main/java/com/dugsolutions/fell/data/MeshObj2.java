package com.dugsolutions.fell.data;
...
public class MeshObj2 {
  ...
  public MeshObj2(AtlasRegion region, float x, float y, float width, float height, int size) {
    texture = region.getTexture();

    build(x, y, width, height,
      region.getU(), region.getV(), region.getU2(), region.getV2(), size);
  ...
  void build(float startX, float startY, float width, float height,
    ...
    Gdx.app.log("DEBUG",
      "STARTX=" + startX + ", STARTY=" + startY + ", W=" + width + ", H=" + height + ", INCY=" + cellSizeY + ", INCX=" + cellSizeX);
