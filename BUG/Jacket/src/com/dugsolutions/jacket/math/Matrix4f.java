...
public class Matrix4f
{
	...
	public final static Matrix4f	IDENTITY	= new Matrix4f(1f, 0, 0, 0, 0, 1f, 0, 0, 0, 0, 1f, 0, 0, 0, 0, 1f);
	...
	{
		return new Vector3f(getValue(0, 3), getValue(1, 3), getValue(2, 3));
	}
	...
	{
		return new Vector3f(getValue(3, 0), getValue(3, 1), getValue(3, 2));
	}
	...
	{
		return new Matrix3f(getValue(0, 0), getValue(0, 1), getValue(0, 2), getValue(1, 0), getValue(1, 1), getValue(1,
				2), getValue(2, 0), getValue(2, 1), getValue(2, 2));
	}
	...
	public Matrix4f mult(final Matrix4f matrix)
	{
		...
		double temp00 = data00 * m00 + data01 * m10 + data02 * m20 + data03 * m30;
		double temp01 = data00 * m01 + data01 * m11 + data02 * m21 + data03 * m31;
		double temp02 = data00 * m02 + data01 * m12 + data02 * m22 + data03 * m32;
		double temp03 = data00 * m03 + data01 * m13 + data02 * m23 + data03 * m33;

		double temp10 = data10 * m00 + data11 * m10 + data12 * m20 + data13 * m30;
		double temp11 = data10 * m01 + data11 * m11 + data12 * m21 + data13 * m31;
		double temp12 = data10 * m02 + data11 * m12 + data12 * m22 + data13 * m32;
		double temp13 = data10 * m03 + data11 * m13 + data12 * m23 + data13 * m33;

		double temp20 = data20 * m00 + data21 * m10 + data22 * m20 + data23 * m30;
		double temp21 = data20 * m01 + data21 * m11 + data22 * m21 + data23 * m31;
		double temp22 = data20 * m02 + data21 * m12 + data22 * m22 + data23 * m32;
		double temp23 = data20 * m03 + data21 * m13 + data22 * m23 + data23 * m33;

		double temp30 = data30 * m00 + data31 * m10 + data32 * m20 + data33 * m30;
		double temp31 = data30 * m01 + data31 * m11 + data32 * m21 + data33 * m31;
		double temp32 = data30 * m02 + data31 * m12 + data32 * m22 + data33 * m32;
		double temp33 = data30 * m03 + data31 * m13 + data32 * m23 + data33 * m33;

		set(temp00, temp01, temp02, temp03, temp10, temp11, temp12, temp13, temp20, temp21, temp22, temp23, temp30,
	...
	{
		set(getValue(0, 0) * scale.getX(), getValue(0, 1) * scale.getY(), getValue(0, 2) * scale.getZ(), getValue(0, 3)
				* scale.getW(),

		getValue(1, 0) * scale.getX(), getValue(1, 1) * scale.getY(), getValue(1, 2) * scale.getZ(), getValue(1, 3)
				* scale.getW(),

		getValue(2, 0) * scale.getX(), getValue(2, 1) * scale.getY(), getValue(2, 2) * scale.getZ(), getValue(2, 3)
				* scale.getW(),

		getValue(3, 0) * scale.getX(), getValue(3, 1) * scale.getY(), getValue(3, 2) * scale.getZ(), getValue(3, 3)
				* scale.getW());
		return this;
	}
