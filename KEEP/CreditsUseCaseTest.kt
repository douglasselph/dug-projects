...
import dugsolutions.leaf.player.effect.DelayedEffectsList
...
class CreditsUseCaseTest {
    ...
    private lateinit var SUT: CreditsUseCase
    ...
    fun invoke_withEmptyDiceAndEffects_returnsEmptyCredits() {
        ...
        every { mockPlayer.delayedEffectList } returns DelayedEffectsList()
    ...
    fun invoke_withAdjustDieRollEffect_returnsCorrectCredits() {
        ...
        every { mockPlayer.diceInHand } returns Dice()
        val adjustment = 2
        val effectsList = DelayedEffectsList().apply {
            addAll(listOf(AppliedEffect.AdjustDieRoll(adjustment)))
        }
        every { mockPlayer.delayedEffectList } returns effectsList
