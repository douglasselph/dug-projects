...
class ScenarioGroveCheapTest {
    ...
    // System under test
    private lateinit var scenarioGroveCheap: ScenarioGroveCheap
    ...
    fun setup() {
        ...
        every { grove.setup(any()) } just Runs

        // Create scenario
        scenarioGroveCheap = ScenarioGroveCheap(grove, cardManager)
    }
    ...
    fun invoke_whenTwoPlayers_setsUpMarketWithCorrectConfig() {
        ...
        every { grove.setup(capture(configSlot)) } just Runs

        // Act
        scenarioGroveCheap(TWO_PLAYERS)
    ...
    fun invoke_whenFourPlayers_setupsMarketWithMoreBonusDice() {
        ...
        // Act
        scenarioGroveCheap(FOUR_PLAYERS)
