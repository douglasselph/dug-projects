...
enum class CardEffect(
    ...
    DRAW_CARD_COMPOST("DrawCardCompost", "Draw VALUE cards from Compost"),
    DRAW_DIE("DrawDie", "Draw VALUE lowest-sided dice"),
    DRAW_DIE_ANY("DrawDieAny", "Draw VALUE dice from Supply"),
    DRAW_DIE_COMPOST("DrawDieCompost", "Draw VALUE lowest-sided dice from Compost."),
    DRAW("Draw", "Draw VALUE cards or dice."),
    ...
    REDUCE_COST_CANOPY("ReduceCostCanopy", "Reduce the cost of a Canopy card by VALUE"),
