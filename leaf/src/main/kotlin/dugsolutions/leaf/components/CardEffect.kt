...
enum class CardEffect(
    ...
    DRAW_THEN_DISCARD("Draw VALUE cards, then discard VALUE-1"),
    ...
    PLACE_IN_ARRAY("Place in Floral Array and then draw a card"),
    ...
    RESILIENCE_BOOST("Boost the resilience of a card"),
    THORN("Attacker takes VALUE damage"),
