...
data class BattleRowAssessment(
    ...
    /** Current totals for participating opponents, used by projected Strike-VP analysis. */
    val participatingOpponentTotals: Map<PlayerId, Int>,
    val highTotal: Int?,
...
class BattleRowAssessor(
    ...
    operator fun invoke(
        ...
        return BattleRowAssessment(
            ...
            participatingOpponentTotals = opponents.associate { it.playerId to it.total },
            highTotal = highTotal,
    ...
    private fun unavailable(
        ...
        BattleRowAssessment(
            ...
            participatingOpponentTotals = emptyMap(),
            highTotal = null,
