...
class DecisionShouldTargetPlayerCoreStrategyTest {

    private lateinit var player: Player
    private lateinit var sampleDie: SampleDie

    private lateinit var SUT: DecisionShouldTargetPlayerCoreStrategy
    ...
    fun setup() {
        ...
        SUT = DecisionShouldTargetPlayerCoreStrategy(player)
    }
    ...
    fun constructor_whenGivenPlayer_setsPlayer() {
        ...
        // Act
        val testStrategy = DecisionShouldTargetPlayerCoreStrategy(testPlayer)
