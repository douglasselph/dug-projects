...
class DecisionShouldProcessTrashEffectBaselineTest {
    ...
    private lateinit var SUT: DecisionShouldProcessTrashEffectBaseline

    @BeforeEach
    fun setup() {
        SUT = DecisionShouldProcessTrashEffectBaseline()
