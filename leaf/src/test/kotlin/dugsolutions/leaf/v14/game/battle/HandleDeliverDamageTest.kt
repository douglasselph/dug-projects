...
import dugsolutions.leaf.v14.player.PlayerTD
...
class HandleDeliverDamageTest {
    ...
    fun setup() {
        ...
        player1 = PlayerTD.Companion("Player 1", 1)
        player2 = PlayerTD.Companion("Player 2", 2)
        player3 = PlayerTD.Companion("Player 3", 3)
        player4 = PlayerTD.Companion("Player 4", 4)
