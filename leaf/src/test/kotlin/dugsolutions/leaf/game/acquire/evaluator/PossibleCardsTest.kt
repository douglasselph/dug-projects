...
class PossibleCardsTest {
    ...
    fun invoke_whenCardsAvailable_returnsSimplifiedChoices() {
        ...
        every { evaluateCardPurchases(marketCards, any(), FakeCombination.combinationD6) } returns listOf(FakeCards.fakeRoot)
        every { evaluateCardPurchases(marketCards, any(), FakeCombination.combinationD8) } returns listOf(FakeCards.fakeRoot2)
    ...
    fun invoke_whenMultipleChoicesForSameCard_returnsSimplifiedChoice() {
        ...
        every { evaluateCardPurchases(marketCards, any(), combination1) } returns listOf(FakeCards.fakeRoot)
