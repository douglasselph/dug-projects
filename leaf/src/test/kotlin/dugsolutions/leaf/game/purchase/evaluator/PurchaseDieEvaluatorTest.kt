...
class PurchaseDieEvaluatorTest {
    ...
    private lateinit var SUT: PurchaseDieEvaluator
    ...
    fun setup() {
        ...
        SUT = PurchaseDieEvaluator(mockSelectPossibleDice, mockEvaluateBestDiePurchase)
        sampleDie = SampleDie()
    }
