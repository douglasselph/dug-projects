...
- [`HUMAN_BASELINE_EFFECT_CHOICES.md`](HUMAN_BASELINE_EFFECT_CHOICES.md) — E-A/E-B inventory, approved Effect Choices contract, 20-hook gap map, and remaining certification checkpoints.
