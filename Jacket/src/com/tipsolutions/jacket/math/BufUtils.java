...
public class BufUtils {
	...
	public static class FloatBuf extends Buffer<FloatBuffer> {
		...
		public FloatBuf(int size) {	super(size); } 
		...
		public int position() { return mBuf.position(); }
		public int remaining() { return mBuf.remaining(); }
	...
	public static class ShortBuf extends Buffer<ShortBuffer> {
		public ShortBuf(int size) {	super(size); }
